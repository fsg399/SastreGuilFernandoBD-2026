...
_DB_USER = os.environ.get('MYSQL_USER', 'biblioteca')
_DB_PASSWORD = os.environ.get('MYSQL_PASSWORD', 'biblioteca123')
_DB_NAME = os.environ.get('MYSQL_DATABASE', 'PrestamosBiblioteca')
